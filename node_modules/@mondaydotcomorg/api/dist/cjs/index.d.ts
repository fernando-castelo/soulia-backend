...
declare class SeamlessApiClient {
     ...
     */
    query<T>(query: string, variables?: QueryVariables, version?: ApiVersionType, timeout?: number): Promise<T>;
    private generateRequestId;
    private addListener;
    private receiveMessage;
}

export { Account, AccountProduct, ActivityLogType, ApiClient, ApiVersionType, AppInstall, AppInstallAccount, AppInstallPermissions, AppInstallUser, AppMonetizationStatus, AppSubscription, AppSubscriptionOperationsCounter, AppVersion, Asset, AssetsSource, AvailableVersions, Board, BoardActivity_LogsArgs, BoardAttributes, BoardColumnsArgs, BoardDuplication, BoardGroupsArgs, BoardItems_PageArgs, BoardKind, BoardObjectType, BoardRelationValue, BoardSubscriberKind, BoardTeam_OwnersArgs, BoardTeam_SubscribersArgs, BoardUpdatesArgs, BoardView, BoardViewsArgs, BoardsOrderBy, ButtonValue, ChangeColumnValueOpDocument, ChangeColumnValueOpMutation, ChangeColumnValueOpMutationVariables, ChangeMultipleColumnValuesOpDocument, ChangeMultipleColumnValuesOpMutation, ChangeMultipleColumnValuesOpMutationVariables, ChangeSimpleColumnValueOpDocument, ChangeSimpleColumnValueOpMutation, ChangeSimpleColumnValueOpMutationVariables, ChangeTeamMembershipsResult, CheckboxValue, ColorPickerValue, Column, ColumnMappingInput, ColumnProperty, ColumnType, ColumnValue, Complexity, Country, CountryValue, CreateItemOpDocument, CreateItemOpMutation, CreateItemOpMutationVariables, CreationLogValue, DEFAULT_VERSION, DateValue, DependencyValue, DocValue, DropdownValue, DropdownValueOption, DuplicateBoardType, EmailValue, Exact, FileAssetValue, FileDocValue, FileLinkValue, FileLinkValueKind, FileValue, FileValueItem, FirstDayOfTheWeek, Folder, FolderColor, FormulaValue, GetBoardGroupsOpDocument, GetBoardGroupsOpQuery, GetBoardGroupsOpQueryVariables, GetBoardItemsOpDocument, GetBoardItemsOpQuery, GetBoardItemsOpQueryVariables, GetMeOpDocument, GetMeOpQuery, GetMeOpQueryVariables, Group, GroupAttributes, GroupItems_PageArgs, GroupValue, HourValue, Incremental, InputMaybe, IntegrationValue, Item, ItemAssetsArgs, ItemColumn_ValuesArgs, ItemIdValue, ItemLinked_ItemsArgs, ItemUpdatesArgs, ItemsOrderByDirection, ItemsPageByColumnValuesQuery, ItemsQuery, ItemsQueryGroup, ItemsQueryOperator, ItemsQueryOrderBy, ItemsQueryRule, ItemsQueryRuleOperator, ItemsResponse, Kind, LastUpdatedValue, LinkValue, LocationValue, LongTextValue, MONDAY_API_ENDPOINT, MakeEmpty, MakeMaybe, MakeOptional, Maybe, MirrorValue, MirroredItem, MirroredValue, Mutation, MutationAdd_File_To_ColumnArgs, MutationAdd_File_To_UpdateArgs, MutationAdd_Subscribers_To_BoardArgs, MutationAdd_Teams_To_BoardArgs, MutationAdd_Teams_To_WorkspaceArgs, MutationAdd_Users_To_BoardArgs, MutationAdd_Users_To_TeamArgs, MutationAdd_Users_To_WorkspaceArgs, MutationArchive_BoardArgs, MutationArchive_GroupArgs, MutationArchive_ItemArgs, MutationChange_Column_MetadataArgs, MutationChange_Column_TitleArgs, MutationChange_Column_ValueArgs, MutationChange_Multiple_Column_ValuesArgs, MutationChange_Simple_Column_ValueArgs, MutationClear_Item_UpdatesArgs, MutationCreate_BoardArgs, MutationCreate_ColumnArgs, MutationCreate_FolderArgs, MutationCreate_GroupArgs, MutationCreate_ItemArgs, MutationCreate_NotificationArgs, MutationCreate_Or_Get_TagArgs, MutationCreate_SubitemArgs, MutationCreate_UpdateArgs, MutationCreate_WebhookArgs, MutationCreate_WorkspaceArgs, MutationDelete_BoardArgs, MutationDelete_ColumnArgs, MutationDelete_FolderArgs, MutationDelete_GroupArgs, MutationDelete_ItemArgs, MutationDelete_Subscribers_From_BoardArgs, MutationDelete_Teams_From_BoardArgs, MutationDelete_Teams_From_WorkspaceArgs, MutationDelete_UpdateArgs, MutationDelete_Users_From_WorkspaceArgs, MutationDelete_WebhookArgs, MutationDelete_WorkspaceArgs, MutationDuplicate_BoardArgs, MutationDuplicate_GroupArgs, MutationDuplicate_ItemArgs, MutationIncrease_App_Subscription_OperationsArgs, MutationLike_UpdateArgs, MutationMove_Item_To_BoardArgs, MutationMove_Item_To_GroupArgs, MutationRemove_Users_From_TeamArgs, MutationUpdate_BoardArgs, MutationUpdate_FolderArgs, MutationUpdate_GroupArgs, MutationUpdate_WorkspaceArgs, Notification, NotificationTargetType, NumberValueUnitDirection, NumbersValue, OutOfOffice, PeopleEntity, PeopleValue, PersonValue, PhoneValue, Plan, PositionRelative, ProgressValue, Query, QueryApp_InstallsArgs, QueryApp_Subscription_OperationsArgs, QueryAssetsArgs, QueryBoardsArgs, QueryFoldersArgs, QueryItemsArgs, QueryItems_Page_By_Column_ValuesArgs, QueryNext_Items_PageArgs, QueryTagsArgs, QueryTeamsArgs, QueryUpdatesArgs, QueryUsersArgs, QueryVariables, QueryWebhooksArgs, QueryWorkspacesArgs, RatingValue, Reply, Scalars, Sdk, SdkFunctionWrapper, SeamlessApiClient, State, StatusLabelStyle, StatusValue, SubtasksValue, Tag, TagsValue, Team, TeamOwnersArgs, TeamUsersArgs, TeamValue, TextValue, TimeTrackingHistoryItem, TimeTrackingValue, TimelineValue, UnsupportedValue, Update, UpdateWorkspaceAttributesInput, User, UserFieldsFragment, UserFieldsFragmentDoc, UserKind, UserTeamsArgs, Version, VersionKind, VoteValue, Webhook, WebhookEventType, WeekValue, Workspace, WorkspaceIcon, WorkspaceKind, WorkspaceOwners_SubscribersArgs, WorkspaceSettings, WorkspaceSubscriberKind, WorkspaceTeam_Owners_SubscribersArgs, WorkspaceTeams_SubscribersArgs, WorkspaceUsers_SubscribersArgs, WorkspacesOrderBy, WorldClockValue, getSdk };
